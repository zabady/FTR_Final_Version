function Controller() {
    function openPicker() {
        $.picker.top = 100;
        animation.popIn($.picker, function() {
            alert("WTF");
        });
    }
    ...
    this.__controllerPath = "phoneNumberWin1";
    ...
    $.__views.__alloyId179.add($.__views.lbl_country_ios);
    ...
    $.__views.__alloyId179.add($.__views.txt_phoneNumber);
    ...
    continueBtnPressed ? $.__views.__alloyId181.addEventListener("click", continueBtnPressed) : __defers["$.__views.__alloyId181!click!continueBtnPressed"] = true;
    ...
    var __alloyId183 = [];
    __alloyId183.push("Edit");
    __alloyId183.push("Confirm");
    $.__views.dialog_confirm = Ti.UI.createAlertDialog({
        buttonNames: __alloyId183,
        id: "dialog_confirm",
    ...
    __defers["$.__views.__alloyId181!click!continueBtnPressed"] && $.__views.__alloyId181.addEventListener("click", continueBtnPressed);
    __defers["$.__views.picker!change!changeCountryAndCountryCode"] && $.__views.picker.addEventListener("change", changeCountryAndCountryCode);
