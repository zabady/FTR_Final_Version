function Controller() {
    ...
    function continueBtnPressed() {
        if (validate_name() && validate_email()) {
            $.win.fireEvent("click");
            var editProfileWin = Alloy.createController("editProfileWin").getView();
            editProfileWin.open();
        }
    }
    ...
    $.__views.btn_facebook = Ti.UI.createButton({
        ...
        bubbleParent: false,
        bottom: "12dp",
        backgroundImage: "/images/import_from_facebook.png",
        id: "btn_facebook"
    });
    $.__views.__alloyId94.add($.__views.btn_facebook);
    ...
    $.__views.__alloyId94.add($.__views.img_user);
    ...
    $.__views.__alloyId94.add($.__views.txt_name);
    ...
    $.__views.__alloyId94.add($.__views.txt_email);
    ...
    $.__views.__alloyId94.add($.__views.lbl_whyMyEmail);
    ...
    continueBtnPressed ? $.__views.__alloyId97.addEventListener("click", continueBtnPressed) : __defers["$.__views.__alloyId97!click!continueBtnPressed"] = true;
    var __alloyId99 = [];
    __alloyId99.push("Open Camera");
    __alloyId99.push("Choose from Library");
    __alloyId99.push("Cancel");
    ...
    __defers["$.__views.__alloyId97!click!continueBtnPressed"] && $.__views.__alloyId97.addEventListener("click", continueBtnPressed);
